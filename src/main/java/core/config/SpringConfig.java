...
public class SpringConfig {
	...
	public DataSource dataSource() throws IllegalArgumentException, NamingException {
		...
		bean.setJndiName("jdbc/chilltribe");
	...
	public SessionFactory sessionFactory() throws IllegalArgumentException, NamingException {
		return new LocalSessionFactoryBuilder(dataSource()).scanPackages("web.*.vo", "core.vo")
	...
	public TransactionManager transactionManager() throws IllegalArgumentException, NamingException {
		return new HibernateTransactionManager(sessionFactory()); // Spring 注入Session 工廠
	}
